...
if($_POST) {	
  ...
  $userid 				= $_SESSION['userId'];
	...
	// Check if the paid amount is less than the grand total
	if($paid < $grandTotalValue) {
		$valid['success'] = false;
		$valid['messages'] = "Transaction failed: Payment amount is less than the total order amount.";
